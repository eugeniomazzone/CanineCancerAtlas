...
BiocManager::install(c("affxparser", "Biostrings", "aroma.light", "BSgenome", "copynumber", "GenomicRanges", "limma", "rhdf5","BSgenome.Cfamiliaris.UCSC.canFam3","maftools","sigminer","ComplexHeatmap"))
